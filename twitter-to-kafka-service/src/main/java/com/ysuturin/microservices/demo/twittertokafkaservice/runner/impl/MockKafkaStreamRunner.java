package com.ysuturin.microservices.demo.twittertokafkaservice.runner.impl;

import com.ysuturin.microservices.demo.config.TwitterToKafkaServiceConfigData;
import com.ysuturin.microservices.demo.twittertokafkaservice.exception.TwitterToKafkaServiceException;
import com.ysuturin.microservices.demo.twittertokafkaservice.listener.TwitterKafkaStatusListener;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        ...
        logger.info("Starting to mock twitter streams for keywords {}", Arrays.toString(keywords));
