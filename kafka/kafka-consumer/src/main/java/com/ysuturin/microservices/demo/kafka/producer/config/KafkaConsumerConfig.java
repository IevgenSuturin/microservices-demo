package com.ysuturin.microservices.demo.kafka.producer.config;

import com.ysuturin.microservices.demo.config.KafkaConfigData;
import com.ysuturin.microservices.demo.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    @Bean
    public Map<String, Object> customerConfigs() {
