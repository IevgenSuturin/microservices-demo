package com.ysuturin.microservices.demo.kafka.admin.client;

import com.ysuturin.microservices.demo.config.KafkaConfigData;
import com.ysuturin.microservices.demo.config.RetryConfigData;
import com.ysuturin.microservices.demo.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    private Logger logger = LoggerFactory.getLogger(KafkaAdminClient.class);
    ...
    private CreateTopicsResult doCreateTopics(RetryContext retryContext) {
        ...
        logger.info("Crating {} topic(s), attempt {}", topicNames.size(), retryContext.getRetryCount());
    ...
    private Collection<TopicListing> doGetTopics(RetryContext retryContext) throws ExecutionException, InterruptedException {
        logger.info("Reading {} topic(s), attempt {}",
